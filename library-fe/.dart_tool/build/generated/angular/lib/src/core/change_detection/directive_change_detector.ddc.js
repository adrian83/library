define(['dart_sdk', 'packages/angular/src/core/application_tokens', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/bootstrap/modules'], function(dart_sdk, packages__angular__src__core__application_tokens, packages__angular__src__core__change_detection__change_detection, packages__angular__src__bootstrap__modules) {
  ...
  const DirectiveChangeDetector_directive = dart.privateName(directive_change_detector, "DirectiveChangeDetector.directive");
  const DirectiveChangeDetector_view = dart.privateName(directive_change_detector, "DirectiveChangeDetector.view");
  const DirectiveChangeDetector_el = dart.privateName(directive_change_detector, "DirectiveChangeDetector.el");
  ...
  const directive = DirectiveChangeDetector_directive;
  const view = DirectiveChangeDetector_view;
  const el = DirectiveChangeDetector_el;
