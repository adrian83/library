define(['dart_sdk', 'packages/collection/src/comparators', 'packages/stack_trace/src/chain', 'packages/logging/logging'], function(dart_sdk, packages__collection__src__comparators, packages__stack_trace__src__chain, packages__logging__logging) {
  ...
  const GenerateInjector__providersOrModules = dart.privateName(injector, "GenerateInjector._providersOrModules");
  ...
  const _providersOrModules$ = GenerateInjector__providersOrModules;
  ...
  opaque_token.OpaqueToken$ = dart.generic(T => {
    ...
    const _uniqueName$ = OpaqueToken__uniqueName;
  ...
  const _FlatProviders_providers = dart.privateName(runtime$, "_FlatProviders.providers");
  const _FlatProviders_multiProviders = dart.privateName(runtime$, "_FlatProviders.multiProviders");
  ...
  const providers$0 = _FlatProviders_providers;
  const multiProviders$ = _FlatProviders_multiProviders;
  ...
  providers$.Provider$ = dart.generic(T => {
    ...
    const useClass$ = Provider_useClass;
    const useValue$ = Provider_useValue;
    const useExisting$ = Provider_useExisting;
    const useFactory$ = Provider_useFactory;
    const deps$ = Provider_deps;
    const multi$ = Provider_multi;
  ...
  const include$ = Module_include;
  const provide$ = Module_provide;
  ...
  let C5;
  const NoProviderError_token = dart.privateName(errors, "NoProviderError.token");
  const NoProviderError_path = dart.privateName(errors, "NoProviderError.path");
  ...
  const token$0 = NoProviderError_token;
  const path = NoProviderError_path;
  ...
  const MapInjector__providers = dart.privateName(map, "MapInjector._providers");
  ...
  const _providers$0 = MapInjector__providers;
  ...
  const SimpleChange_previousValue = dart.privateName(change_detection_util, "SimpleChange.previousValue");
  const SimpleChange_currentValue = dart.privateName(change_detection_util, "SimpleChange.currentValue");
  ...
  const previousValue$ = SimpleChange_previousValue;
  const currentValue$ = SimpleChange_currentValue;
  ...
  const Typed_on = dart.privateName(typed, "Typed.on");
  const Typed_typeArguments = dart.privateName(typed, "Typed.typeArguments");
  typed.Typed$ = dart.generic(T => {
    ...
    const on$ = Typed_on;
    const typeArguments$ = Typed_typeArguments;
  ...
  const KeyValueChangeRecord_key = dart.privateName(default_keyvalue_differ, "KeyValueChangeRecord.key");
  const KeyValueChangeRecord_previousValue = dart.privateName(default_keyvalue_differ, "KeyValueChangeRecord.previousValue");
  const KeyValueChangeRecord_currentValue = dart.privateName(default_keyvalue_differ, "KeyValueChangeRecord.currentValue");
  ...
  const key$ = KeyValueChangeRecord_key;
  const previousValue = KeyValueChangeRecord_previousValue;
  const currentValue = KeyValueChangeRecord_currentValue;
  ...
  const CollectionChangeRecord_item = dart.privateName(default_iterable_differ, "CollectionChangeRecord.item");
  const CollectionChangeRecord_trackById = dart.privateName(default_iterable_differ, "CollectionChangeRecord.trackById");
  const CollectionChangeRecord_currentIndex = dart.privateName(default_iterable_differ, "CollectionChangeRecord.currentIndex");
  const CollectionChangeRecord_previousIndex = dart.privateName(default_iterable_differ, "CollectionChangeRecord.previousIndex");
  ...
  const item$ = CollectionChangeRecord_item;
  const trackById$ = CollectionChangeRecord_trackById;
  const currentIndex = CollectionChangeRecord_currentIndex;
  const previousIndex = CollectionChangeRecord_previousIndex;
  ...
  const NgZoneError_error = dart.privateName(ng_zone, "NgZoneError.error");
  const NgZoneError_stackTrace = dart.privateName(ng_zone, "NgZoneError.stackTrace");
  ...
  const error$ = NgZoneError_error;
  const stackTrace$ = NgZoneError_stackTrace;
  ...
  let C22;
  const Directive_selector = dart.privateName(metadata, "Directive.selector");
  const Directive_providers = dart.privateName(metadata, "Directive.providers");
  const Directive_exportAs = dart.privateName(metadata, "Directive.exportAs");
  const Directive_visibility = dart.privateName(metadata, "Directive.visibility");
  ...
  const selector$ = Directive_selector;
  const providers$1 = Directive_providers;
  const exportAs$ = Directive_exportAs;
  const visibility$ = Directive_visibility;
  ...
  const Component_changeDetection = dart.privateName(metadata, "Component.changeDetection");
  const Component_viewProviders = dart.privateName(metadata, "Component.viewProviders");
  const Component_exports = dart.privateName(metadata, "Component.exports");
  const Component_templateUrl = dart.privateName(metadata, "Component.templateUrl");
  const Component_template = dart.privateName(metadata, "Component.template");
  const Component_preserveWhitespace = dart.privateName(metadata, "Component.preserveWhitespace");
  const Component_styleUrls = dart.privateName(metadata, "Component.styleUrls");
  const Component_styles = dart.privateName(metadata, "Component.styles");
  const Component_directives = dart.privateName(metadata, "Component.directives");
  const Component_directiveTypes = dart.privateName(metadata, "Component.directiveTypes");
  const Component_pipes = dart.privateName(metadata, "Component.pipes");
  const Component_encapsulation = dart.privateName(metadata, "Component.encapsulation");
  ...
  const changeDetection$ = Component_changeDetection;
  const viewProviders$ = Component_viewProviders;
  const exports$ = Component_exports;
  const templateUrl$ = Component_templateUrl;
  const template$ = Component_template;
  const preserveWhitespace$ = Component_preserveWhitespace;
  const styleUrls$ = Component_styleUrls;
  const styles$ = Component_styles;
  const directives$ = Component_directives;
  const directiveTypes$ = Component_directiveTypes;
  const pipes$ = Component_pipes;
  const encapsulation$ = Component_encapsulation;
  ...
  const Pipe_name = dart.privateName(metadata, "Pipe.name");
  const Pipe_pure = dart.privateName(metadata, "Pipe.pure");
  ...
  const name$ = Pipe_name;
  const pure$ = Pipe_pure;
  ...
  const Attribute_attributeName = dart.privateName(metadata, "Attribute.attributeName");
  ...
  const attributeName$ = Attribute_attributeName;
  ...
  const _Query_selector = dart.privateName(metadata, "_Query.selector");
  const _Query_descendants = dart.privateName(metadata, "_Query.descendants");
  const _Query_first = dart.privateName(metadata, "_Query.first");
  const _Query_read = dart.privateName(metadata, "_Query.read");
  ...
  const selector$0 = _Query_selector;
  const descendants$ = _Query_descendants;
  const first$ = _Query_first;
  const read$ = _Query_read;
  ...
  const Input_bindingPropertyName = dart.privateName(metadata, "Input.bindingPropertyName");
  ...
  const bindingPropertyName$ = Input_bindingPropertyName;
  ...
  const Output_bindingPropertyName = dart.privateName(metadata, "Output.bindingPropertyName");
  ...
  const bindingPropertyName$0 = Output_bindingPropertyName;
  ...
  const HostBinding_hostPropertyName = dart.privateName(metadata, "HostBinding.hostPropertyName");
  ...
  const hostPropertyName$ = HostBinding_hostPropertyName;
  ...
  const HostListener_eventName = dart.privateName(metadata, "HostListener.eventName");
  const HostListener_args = dart.privateName(metadata, "HostListener.args");
  ...
  const eventName$ = HostListener_eventName;
  const args$ = HostListener_args;
  ...
  const ExceptionHandler__logger = dart.privateName(exception_handler, "ExceptionHandler._logger");
  ...
  const _logger$ = ExceptionHandler__logger;
