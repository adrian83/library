define(['dart_sdk', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/core/change_detection/change_detection.template', 'packages/angular/src/core/application_tokens.template', 'packages/angular/di.template', 'packages/angular/core.template', 'packages/intl/intl', 'packages/logging/logging', 'packages/angular/src/core/application_tokens'], function(dart_sdk, packages__angular__src__core__change_detection__change_detection, packages__angular__src__core__change_detection__change_detection$46template, packages__angular__src__core__application_tokens$46template, packages__angular__di$46template, packages__angular__core$46template, packages__intl__intl, packages__logging__logging, packages__angular__src__core__application_tokens) {
  ...
  const ChangeDetectionPerfRecord_msPerTick = dart.privateName(common_tools, "ChangeDetectionPerfRecord.msPerTick");
  const ChangeDetectionPerfRecord_numTicks = dart.privateName(common_tools, "ChangeDetectionPerfRecord.numTicks");
  ...
  const msPerTick$ = ChangeDetectionPerfRecord_msPerTick;
  const numTicks$ = ChangeDetectionPerfRecord_numTicks;
  ...
  const AngularTools_profiler = dart.privateName(common_tools, "AngularTools.profiler");
  ...
  const profiler = AngularTools_profiler;
  ...
  const AngularProfiler_appRef = dart.privateName(common_tools, "AngularProfiler.appRef");
  ...
  const appRef = AngularProfiler_appRef;
  ...
  component_factory.ComponentFactory$ = dart.generic(T => {
    ...
    const selector$ = ComponentFactory_selector;
    const _viewFactory$ = ComponentFactory__viewFactory;
  ...
  const AppViewData_type = dart.privateName(app_view, "AppViewData.type");
  const AppViewData_locals = dart.privateName(app_view, "AppViewData.locals");
  const AppViewData_destroyed = dart.privateName(app_view, "AppViewData.destroyed");
  const AppViewData_projectedNodes = dart.privateName(app_view, "AppViewData.projectedNodes");
  const AppViewData_subscriptions = dart.privateName(app_view, "AppViewData.subscriptions");
  const AppViewData_rootFragment = dart.privateName(app_view, "AppViewData.rootFragment");
  const AppViewData_parentIndex = dart.privateName(app_view, "AppViewData.parentIndex");
  ...
  const type$ = AppViewData_type;
  const locals = AppViewData_locals;
  const destroyed = AppViewData_destroyed;
  const projectedNodes = AppViewData_projectedNodes;
  const subscriptions = AppViewData_subscriptions;
  const rootFragment = AppViewData_rootFragment;
  const parentIndex$ = AppViewData_parentIndex;
  ...
  const AppView_rootEl = dart.privateName(app_view, "AppView.rootEl");
  const AppView_ctx = dart.privateName(app_view, "AppView.ctx");
  const AppView_componentStyles = dart.privateName(app_view, "AppView.componentStyles");
  const AppView_parentView = dart.privateName(app_view, "AppView.parentView");
  const AppView_viewData = dart.privateName(app_view, "AppView.viewData");
  app_view.AppView$ = dart.generic(T => {
    ...
    const rootEl = AppView_rootEl;
    const ctx = AppView_ctx;
    const componentStyles = AppView_componentStyles;
    const parentView$ = AppView_parentView;
    const viewData = AppView_viewData;
  ...
  const ViewFragment__nodesOrViewContainers = dart.privateName(view_fragment, "ViewFragment._nodesOrViewContainers");
  ...
  const _nodesOrViewContainers$ = ViewFragment__nodesOrViewContainers;
  ...
  const ViewContainer_index = dart.privateName(view_container, "ViewContainer.index");
  const ViewContainer_parentIndex = dart.privateName(view_container, "ViewContainer.parentIndex");
  const ViewContainer_parentView = dart.privateName(view_container, "ViewContainer.parentView");
  const ViewContainer_nativeElement = dart.privateName(view_container, "ViewContainer.nativeElement");
  const ViewContainer_nestedViews = dart.privateName(view_container, "ViewContainer.nestedViews");
  ...
  const index$ = ViewContainer_index;
  const parentIndex$0 = ViewContainer_parentIndex;
  const parentView$ = ViewContainer_parentView;
  const nativeElement$ = ViewContainer_nativeElement;
  const nestedViews = ViewContainer_nestedViews;
  ...
  const _viewFactory$ = dart.privateName(template_ref, "_viewFactory");
  ...
  dart.setFieldSignature(template_ref.TemplateRef, () => ({
    ...
    [_viewFactory$]: dart.finalFieldType(dart.fnType(app_view.AppView$(dart.void), [app_view.AppView$(core.Object), core.int]))
  }));
  const ElementRef_nativeElement = dart.privateName(element_ref, "ElementRef.nativeElement");
  ...
  const nativeElement$0 = ElementRef_nativeElement;
  ...
  const AppViewUtils_appId = dart.privateName(app_view_utils, "AppViewUtils.appId");
  const AppViewUtils_eventManager = dart.privateName(app_view_utils, "AppViewUtils.eventManager");
  const AppViewUtils_sanitizer = dart.privateName(app_view_utils, "AppViewUtils.sanitizer");
  ...
  const appId$ = AppViewUtils_appId;
  const eventManager$ = AppViewUtils_eventManager;
  const sanitizer$ = AppViewUtils_sanitizer;
  ...
  const EventManager_zone = dart.privateName(dom_events, "EventManager.zone");
  ...
  const _ParsedEvent_domEventName = dart.privateName(dom_events, "_ParsedEvent.domEventName");
  const _ParsedEvent_keyAndModifiers = dart.privateName(dom_events, "_ParsedEvent.keyAndModifiers");
  ...
  const domEventName$ = _ParsedEvent_domEventName;
  const keyAndModifiers$ = _ParsedEvent_keyAndModifiers;
  ...
  const ComponentStyles_contentPrefix = dart.privateName(style_encapsulation, "ComponentStyles.contentPrefix");
  const ComponentStyles_hostPrefix = dart.privateName(style_encapsulation, "ComponentStyles.hostPrefix");
  ...
  const contentPrefix$ = ComponentStyles_contentPrefix;
  const hostPrefix$ = ComponentStyles_hostPrefix;
  ...
  const _loader$ = SlowComponentLoader__loader;
  ...
  const SafeValueImpl_changingThisWillBypassSecurityTrust = dart.privateName(dom_sanitization_service_impl, "SafeValueImpl.changingThisWillBypassSecurityTrust");
  ...
  const changingThisWillBypassSecurityTrust$ = SafeValueImpl_changingThisWillBypassSecurityTrust;
  ...
  exceptions$.BrowserExceptionHandler = class BrowserExceptionHandler extends core.Object {
    ...
    get [_logger$]() {
      return logging.Logger._check(this[$noSuchMethod](new core._Invocation.getter(C43 || CT.C43)));
    }
  };
  ...
  const _LazyInjector__providers = dart.privateName(run, "_LazyInjector._providers");
  ...
  const _providers$ = _LazyInjector__providers;
