define(['dart_sdk', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/bootstrap/modules', 'packages/collection/src/comparators'], function(dart_sdk, packages__angular__src__core__change_detection__change_detection, packages__angular__src__bootstrap__modules, packages__collection__src__comparators) {
  ...
  const Url_fragment = dart.privateName(url$, "Url.fragment");
  const Url_path = dart.privateName(url$, "Url.path");
  const Url_queryParameters = dart.privateName(url$, "Url.queryParameters");
  ...
  const path$ = Url_path;
  const queryParameters$ = Url_queryParameters;
  ...
  const RouterState_routes = dart.privateName(router_state, "RouterState.routes");
  const RouterState_parameters = dart.privateName(router_state, "RouterState.parameters");
  ...
  const routes$ = RouterState_routes;
  const parameters$ = RouterState_parameters;
  ...
  const MutableRouterState_components = dart.privateName(router_state, "MutableRouterState.components");
  const MutableRouterState_factories = dart.privateName(router_state, "MutableRouterState.factories");
  const MutableRouterState_routes = dart.privateName(router_state, "MutableRouterState.routes");
  const MutableRouterState_fragment = dart.privateName(router_state, "MutableRouterState.fragment");
  const MutableRouterState_path = dart.privateName(router_state, "MutableRouterState.path");
  const MutableRouterState_queryParameters = dart.privateName(router_state, "MutableRouterState.queryParameters");
  ...
  const components = MutableRouterState_components;
  const factories = MutableRouterState_factories;
  const routes = MutableRouterState_routes;
  const fragment = MutableRouterState_fragment;
  const path = MutableRouterState_path;
  const queryParameters = MutableRouterState_queryParameters;
  ...
  const RoutePath_path = dart.privateName(route_path, "RoutePath.path");
  const RoutePath_parent = dart.privateName(route_path, "RoutePath.parent");
  const RoutePath_useAsDefault = dart.privateName(route_path, "RoutePath.useAsDefault");
  const RoutePath_additionalData = dart.privateName(route_path, "RoutePath.additionalData");
  ...
  const path$0 = RoutePath_path;
  const parent$ = RoutePath_parent;
  const useAsDefault$ = RoutePath_useAsDefault;
  const additionalData$ = RoutePath_additionalData;
  ...
  let C2;
  const RouteDefinition_path = dart.privateName(route_definition, "RouteDefinition.path");
  const RouteDefinition_useAsDefault = dart.privateName(route_definition, "RouteDefinition.useAsDefault");
  const RouteDefinition_additionalData = dart.privateName(route_definition, "RouteDefinition.additionalData");
  ...
  const path$1 = RouteDefinition_path;
  const useAsDefault$0 = RouteDefinition_useAsDefault;
  const additionalData$0 = RouteDefinition_additionalData;
  ...
  const ComponentRouteDefinition_component = dart.privateName(route_definition, "ComponentRouteDefinition.component");
  ...
  const component$ = ComponentRouteDefinition_component;
  ...
  const DeferredRouteDefinition_loader = dart.privateName(route_definition, "DeferredRouteDefinition.loader");
  const DeferredRouteDefinition_prefetcher = dart.privateName(route_definition, "DeferredRouteDefinition.prefetcher");
  ...
  const loader$ = DeferredRouteDefinition_loader;
  const prefetcher$ = DeferredRouteDefinition_prefetcher;
  ...
  const RedirectRouteDefinition_redirectTo = dart.privateName(route_definition, "RedirectRouteDefinition.redirectTo");
  ...
  const redirectTo$ = RedirectRouteDefinition_redirectTo;
  ...
  const Location_locationStrategy = dart.privateName(location$, "Location.locationStrategy");
  ...
  const locationStrategy$ = Location_locationStrategy;
  ...
  const NavigationParams_queryParameters = dart.privateName(navigation_params, "NavigationParams.queryParameters");
  const NavigationParams_fragment = dart.privateName(navigation_params, "NavigationParams.fragment");
  const NavigationParams_reload = dart.privateName(navigation_params, "NavigationParams.reload");
  const NavigationParams_replace = dart.privateName(navigation_params, "NavigationParams.replace");
  const NavigationParams_updateUrl = dart.privateName(navigation_params, "NavigationParams.updateUrl");
  ...
  const queryParameters$0 = NavigationParams_queryParameters;
  const fragment$0 = NavigationParams_fragment;
  const reload$ = NavigationParams_reload;
  const replace$ = NavigationParams_replace;
  const updateUrl$ = NavigationParams_updateUrl;
  ...
  const RouterOutletToken_routerOutlet = dart.privateName(router_outlet_token, "RouterOutletToken.routerOutlet");
  ...
  const routerOutlet = RouterOutletToken_routerOutlet;
