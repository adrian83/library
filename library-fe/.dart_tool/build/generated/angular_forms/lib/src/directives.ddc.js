define(['dart_sdk', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/core/application_tokens'], function(dart_sdk, packages__angular__src__core__change_detection__change_detection, packages__angular__src__core__application_tokens) {
  ...
  const RequiredValidator_required = dart.privateName(validators, "RequiredValidator.required");
  ...
  const required = RequiredValidator_required;
  ...
  const MinLengthValidator_minLengthAttr = dart.privateName(validators, "MinLengthValidator.minLengthAttr");
  ...
  const minLengthAttr = MinLengthValidator_minLengthAttr;
  ...
  const MaxLengthValidator_maxLengthAttr = dart.privateName(validators, "MaxLengthValidator.maxLengthAttr");
  ...
  const maxLengthAttr = MaxLengthValidator_maxLengthAttr;
  ...
  const PatternValidator_pattern = dart.privateName(validators, "PatternValidator.pattern");
  ...
  const pattern = PatternValidator_pattern;
  ...
  const AbstractControl_validator = dart.privateName(model, "AbstractControl.validator");
  model.AbstractControl$ = dart.generic(T => {
    ...
    const validator$ = AbstractControl_validator;
  ...
  const AbstractControlGroup_controls = dart.privateName(model, "AbstractControlGroup.controls");
  model.AbstractControlGroup$ = dart.generic(T => {
    ...
    const controls$ = AbstractControlGroup_controls;
  ...
  const ControlArray_controls = dart.privateName(model, "ControlArray.controls");
  ...
  const controls$ = ControlArray_controls;
  ...
  const AbstractControlDirective_name = dart.privateName(abstract_control_directive, "AbstractControlDirective.name");
  abstract_control_directive.AbstractControlDirective$ = dart.generic(T => {
    ...
    const name = AbstractControlDirective_name;
  ...
  const NgControlGroup_validator = dart.privateName(ng_control_group, "NgControlGroup.validator");
  ...
  const validator = NgControlGroup_validator;
  ...
  const TouchHandler_onTouched = dart.privateName(control_value_accessor, "TouchHandler.onTouched");
  ...
  const onTouched = TouchHandler_onTouched;
  ...
  const ChangeHandler_onChange = dart.privateName(control_value_accessor, "ChangeHandler.onChange");
  control_value_accessor.ChangeHandler$ = dart.generic(T => {
    ...
    const onChange = ChangeHandler_onChange;
  ...
  const SelectControlValueAccessor_value = dart.privateName(select_control_value_accessor, "SelectControlValueAccessor.value");
  ...
  const value$ = SelectControlValueAccessor_value;
  ...
  const NgSelectOption_id = dart.privateName(select_control_value_accessor, "NgSelectOption.id");
  ...
  const RadioButtonState_checked = dart.privateName(radio_control_value_accessor, "RadioButtonState.checked");
  const RadioButtonState_value = dart.privateName(radio_control_value_accessor, "RadioButtonState.value");
  ...
  const checked$ = RadioButtonState_checked;
  const value$0 = RadioButtonState_value;
  ...
  const RadioControlValueAccessor_name = dart.privateName(radio_control_value_accessor, "RadioControlValueAccessor.name");
  const Object_TouchHandler$36$ = class Object_TouchHandler extends core.Object {};
  (Object_TouchHandler$36$.new = function() {
    control_value_accessor.TouchHandler.new.call(this);
  }).prototype = Object_TouchHandler$36$.prototype;
  ...
  const name = RadioControlValueAccessor_name;
  ...
  const NgControl_valueAccessor = dart.privateName(ng_control, "NgControl.valueAccessor");
  const NgControl_validator = dart.privateName(ng_control, "NgControl.validator");
  ...
  const valueAccessor = NgControl_valueAccessor;
  const validator$ = NgControl_validator;
  ...
  const AbstractNgForm_form = dart.privateName(ng_form, "AbstractNgForm.form");
  ng_form.AbstractNgForm$ = dart.generic(T => {
    ...
    const form = AbstractNgForm_form;
  ...
  const NgFormModel_directives = dart.privateName(ng_form_model, "NgFormModel.directives");
  ...
  const directives$ = NgFormModel_directives;
  ...
  const NgModel_viewModel = dart.privateName(ng_model, "NgModel.viewModel");
  ...
  const viewModel = NgModel_viewModel;
  ...
  const NgFormControl_viewModel = dart.privateName(ng_form_control, "NgFormControl.viewModel");
  ...
  const viewModel$ = NgFormControl_viewModel;
  ...
  const NgControlName_viewModel = dart.privateName(ng_control_name, "NgControlName.viewModel");
  ...
  const viewModel$0 = NgControlName_viewModel;
