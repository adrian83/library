define(['dart_sdk', 'packages/string_scanner/src/eager_span_scanner', 'packages/source_span/source_span', 'packages/collection/src/canonicalized_map', 'packages/typed_data/typed_buffers'], function(dart_sdk, packages__string_scanner__src__eager_span_scanner, packages__source_span__source_span, packages__collection__src__canonicalized_map, packages__typed_data__typed_buffers) {
  ...
  const AuthenticationChallenge_scheme = dart.privateName(authentication_challenge, "AuthenticationChallenge.scheme");
  const AuthenticationChallenge_parameters = dart.privateName(authentication_challenge, "AuthenticationChallenge.parameters");
  ...
  const scheme$ = AuthenticationChallenge_scheme;
  const parameters$ = AuthenticationChallenge_parameters;
  ...
  const MediaType_type = dart.privateName(media_type, "MediaType.type");
  const MediaType_subtype = dart.privateName(media_type, "MediaType.subtype");
  const MediaType_parameters = dart.privateName(media_type, "MediaType.parameters");
  ...
  const type$ = MediaType_type;
  const subtype$ = MediaType_subtype;
  const parameters$0 = MediaType_parameters;
